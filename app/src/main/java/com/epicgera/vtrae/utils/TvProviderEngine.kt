...
object TvProviderEngine {
    ...
    private const val TV_INPUT_SERVICE_CLASS = "com.epicgera.vtrae.service.VtraeTvInputService"
    ...
    /**
     * Publishes a master channel for VTR Æ to the Android TV Home Screen.
     */
    suspend fun setupCustomChannel(context: Context) {
        ...
        val values = ContentValues().apply {
            ...
            put(TvContract.Channels.COLUMN_DISPLAY_NAME, "VTR Æ Live TV")
