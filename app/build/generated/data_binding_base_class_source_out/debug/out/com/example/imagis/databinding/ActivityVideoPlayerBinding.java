...
public final class ActivityVideoPlayerBinding implements ViewBinding {
  ...
  private ActivityVideoPlayerBinding(@NonNull FrameLayout rootView, @NonNull PlayerView videoView) {
  ...
  public static ActivityVideoPlayerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityVideoPlayerBinding((FrameLayout) rootView, videoView);
    }
